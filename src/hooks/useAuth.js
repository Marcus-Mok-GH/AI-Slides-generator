...
export default function useAuth() {
  ...
  const signIn = useCallback(() => {
    // Standard Replit Auth flow: top-level navigation to /api/login. The
    // server starts the OIDC dance and ultimately redirects the browser
    // back to "/" with a fresh session cookie.
